...
other='fractional-triangle-lean-ja' if meta['role']=='canonical' else 'fractional-triangle-lean'
...
readme.write_text(text+'\n\n<!-- EDITION_LINKS -->\n[English source](https://github.com/'+args.owner+'/fractional-triangle-lean) · [日本語解説](https://github.com/'+args.owner+'/fractional-triangle-lean-ja)\n')
